...
public class SwaggerConfig {
	...
	public OpenAPI customOpenAPI() {
		...
		return new OpenAPI().info(new Info().title("Spring Security JWT Authentication Service"))
				...
				.components(new Components().addSecuritySchemes("JavaSecurityScheme",
						new SecurityScheme().name("JavaSecurityScheme").type(SecurityScheme.Type.HTTP)
